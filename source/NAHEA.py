...
class NAHEA_nFeatures_BinClass_5(NAHEA):
    """NAHEA model with n features.
    Now with a learned output layer
    Number of qubits is defined by the number of positions in parameters.
    """
    ...
    def __init__(
        ...
        hparams: dict,
        parameters: dict,
        name: str = "NAHEA_nFeatures_BinClass_5 model",
    ):
        """ """
        self.parameters_required_keys = [
            "positions",
...
class NAHEA_nFeatures_BinClass_6(NAHEA):
    """NAHEA model with n features.
    Now with a learned output layer
    Number of qubits is defined by the number of positions in parameters.
    """
    ...
    def __init__(
        ...
        hparams: dict,
        parameters: dict,
        name: str = "NAHEA_nFeatures_BinClass_6 model",
    ):
        """ """
        self.parameters_required_keys = [
            "positions",
...
def test_NAHEA_nFeatures_BinClass_5():
    hparams = {
        "n_features": (n_features := 2),
        "sampling_rate": 0.4,
        "protocol": "min-delay",
    ...
    model = NAHEA_nFeatures_BinClass_5(
        hparams=hparams,
        parameters=parameters,
        name="Test Model with learned output layer and input embedding",
    )
    print(model)
...
def test_NAHEA_nFeatures_BinClass_6():
    # global_pulse_omega_1 = torch.abs(self._parameters["global_pulse_omega_1"])
    # global_pulse_omega_2 = torch.abs(self._parameters["global_pulse_omega_2"])
    # global_pulse_delta_1 = self._parameters["global_pulse_delta_1"]
    # global_pulse_delta_2 = self._parameters["global_pulse_delta_2"]
    ...
    model = NAHEA_nFeatures_BinClass_6(
        hparams=hparams,
        parameters=parameters,
        name="Test Model with learned output layer and input embedding",
    )
...
if __name__ == "__main__":
    ...
    # test_NAHEA_nFeatures_BinClass_5()
    test_NAHEA_nFeatures_BinClass_6()
